"""
HillclimberFold Class
Date of Creation: 2024-01-31
Description: This class implements the Hillclimber algorithm for
             protein folding optimization.
             It takes a random protein fold and tries to improve it by
             randomly changing the position of a snippet of the protein.
             If the new protein fold is better than the current highscore,
             it becomes the new highscore.
